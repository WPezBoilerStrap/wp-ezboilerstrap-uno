...
?>
  ...
  <?php 
	...
	WP_ezMethods::ez_gtp( $arr_single_content_center_wrap['tp']['content_below']['slug'], $arr_single_content_center_wrap['tp']['content_below']['name'], $arr_single_content_center_wrap['tp']['content_below']['active'] );
