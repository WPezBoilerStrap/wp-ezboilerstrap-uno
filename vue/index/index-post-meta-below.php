...
if ( WPezHelpers::ez_true($arr_index_post_meta_below, 'active') ){

global $post;
  
  echo '<div class="' . esc_attr($arr_index_post_meta_below['markup']['wrap_class']) . ' wp-ezbs-index-meta  wp-ezbs-index-meta-below' . '">';
