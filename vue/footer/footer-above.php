...
if ( isset($arr_footer_above['active']) && $arr_footer_above['active'] === true ){
  ...
  foreach ( $arr_footer_above['ds'] as $str_key => $arr_value){
    ...
    if ( WP_ezMethods::ez_ias( $arr_footer_above['ds'][$str_key]['index'], $arr_footer_above['ds'][$str_key]['active']) ) {
      ...
      echo '<div class="' . sanitize_text_field($arr_footer_above['ds'][$str_key]['css']['class']) . ' wp-ezbs-header-above' . '">';
