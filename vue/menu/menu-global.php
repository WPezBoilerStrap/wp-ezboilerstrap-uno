...
if ( WPezHelpers::ez_true($arr_menu_global, 'active') ){	
	...
	echo '<div class="' . esc_attr($arr_menu_global['markup']['wrap_class']) . '">';
	  echo '<div class="' . esc_attr($arr_menu_global['markup']['class_container']) . '">';
		echo '<div class="' . esc_attr($arr_menu_global['markup']['navbar_class']) . '">';
		  ...
		  if ( WPezHelpers::ez_array_pass($arr_menu_global['menu_args'])  && WPezHelpers::ez_true($arr_menu_global['menu_args'], 'active') ){ 
			...
			if ( ! empty ($str_wp_nav_menu) ){
		      ?>
			  <button type="button" class="<?php echo esc_attr($arr_menu_global['markup']['button_class']) ?>" data-toggle="<?php echo esc_attr($arr_menu_global['markup']['button_data_toggle']) ?>" data-target="<?php echo esc_attr($arr_menu_global['markup']['data_target']) ?>">
